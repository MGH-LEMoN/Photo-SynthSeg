...
def labels_to_image_model(
    ...
    # apply bias field
    if bias_field_std > 0:
        image = layers.BiasFieldCorruption(
            bias_field_std, bias_shape_factor, same_bias_for_all_channels
        )(image)

    # intensity augmentation
    image = layers.IntensityAugmentation(
        clip=300, normalise=True, gamma_std=0.4, separate_channels=True
    )(image)
