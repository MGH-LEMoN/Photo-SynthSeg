...
PARAM_FILES_DIR = os.path.join(
    DATA_DIR, "SynthSeg_param_files_manual_auto_photos_noCerebellumOrBrainstem"
)

GENERATION_LABELS = os.path.join(
    PARAM_FILES_DIR, "generation_charm_choroid_lesions.npy"
)
