...
parser_a.add_argument('checkpoint_folder',
                      type=str,
                      help='''Folder containing previous checkpoints
Must contain either w2l_*.h5 or dice_*.h5''')

# create the parser for the "train" command
parser_b = subparsers.add_parser('train',
                                 help='Use this sub-command for training')
# ------------------------------------------------- General parameters -------------------------------------------------
...
parser_b.add_argument("--generation_labels",
                      type=str,
                      dest="generation_labels",
                      default=None)
parser_b.add_argument("--neutral_labels",
                      type=int,
                      dest="n_neutral_labels",
                      default=None)
parser_b.add_argument("--segmentation_labels",
                      type=str,
...
parser_b.add_argument("--target_res",
                      nargs='?',
                      type=float,
                      dest="target_res",
                      default=None)
parser_b.add_argument("--output_shape",
                      type=int,
                      dest="output_shape",
                      default=None)

# GMM-sampling parameters
parser_b.add_argument("--generation_classes",
                      type=str,
                      dest="generation_classes",
                      default=None)
parser_b.add_argument("--prior_type",
                      type=str,
                      dest="prior_distributions",
                      default='uniform')
parser_b.add_argument("--prior_means",
                      nargs='?',
                      type=infer,
                      dest="prior_means",
                      default=None)
parser_b.add_argument("--prior_stds",
                      nargs='?',
                      type=infer,
                      dest="prior_stds",
                      default=None)
parser_b.add_argument("--specific_stats",
                      action='store_true',
                      dest="use_specific_stats_for_channel")
parser_b.add_argument("--mix_prior_and_random",
                      action='store_true',
                      dest="mix_prior_and_random")

# spatial deformation parameters
parser_b.add_argument("--no_flipping", action='store_false', dest="flipping")
parser_b.add_argument("--scaling",
                      nargs='?',
                      dest="scaling_bounds",
                      type=infer,
                      default=0.15)
parser_b.add_argument("--rotation",
                      nargs='?',
                      dest="rotation_bounds",
                      type=infer,
                      default=15)
parser_b.add_argument("--shearing",
                      nargs='?',
                      dest="shearing_bounds",
                      type=infer,
                      default=.012)
parser_b.add_argument("--translation",
                      nargs='?',
                      dest="translation_bounds",
                      type=infer,
                      default=False)
parser_b.add_argument("--nonlin_std",
                      type=infer,
                      dest="nonlin_std",
                      default=3.)
parser_b.add_argument("--nonlin_shape_factor",
                      type=infer,
                      dest="nonlin_shape_factor",
                      default=.04)

# blurring/resampling parameters
parser_b.add_argument("--randomise_res",
                      action='store_true',
                      dest="randomise_res")
parser_b.add_argument("--max_res_iso",
                      type=float,
                      dest="max_res_iso",
                      default=4.)
parser_b.add_argument("--max_res_aniso",
                      type=float,
                      dest="max_res_aniso",
                      default=8.)
parser_b.add_argument("--data_res", dest="data_res", type=infer, default=None)
parser_b.add_argument("--thickness",
                      dest="thickness",
                      type=infer,
                      default=None)
parser_b.add_argument("--downsample", action='store_true', dest="downsample")
parser_b.add_argument("--blur_range",
                      type=float,
                      dest="blur_range",
                      default=1.03)

# bias field parameters
parser_b.add_argument("--bias_std",
                      type=float,
                      dest="bias_field_std",
                      default=.5)
parser_b.add_argument("--bias_shape_factor",
                      type=infer,
                      dest="bias_shape_factor",
                      default=.025)
...
parser_b.add_argument("--conv_per_level",
                      type=int,
                      dest="nb_conv_per_level",
                      default=2)
parser_b.add_argument("--conv_size", type=int, dest="conv_size", default=3)
parser_b.add_argument("--unet_feat",
                      type=int,
                      dest="unet_feat_count",
                      default=24)
parser_b.add_argument("--feat_mult",
                      type=int,
                      dest="feat_multiplier",
                      default=2)
parser_b.add_argument("--activation",
                      type=str,
                      dest="activation",
                      default='elu')
...
parser_b.add_argument("--dice_epochs",
                      type=int,
                      dest="dice_epochs",
                      default=300)
parser_b.add_argument("--steps_per_epoch",
                      type=int,
                      dest="steps_per_epoch",
                      default=1000)
parser_b.add_argument("--checkpoint",
                      type=str,
                      dest="checkpoint",
                      default=None)
