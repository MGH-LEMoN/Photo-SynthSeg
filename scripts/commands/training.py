...
parser.add_argument("--noisy_patches", nargs='?', type=str, dest="patch_dir", default=None)
...
parser.add_argument("--target_res", nargs='?', type=float, dest="target_res", default=None)
...
parser.add_argument("--prior_means", nargs='?', type=infer, dest="prior_means", default=None)
parser.add_argument("--prior_stds", nargs='?', type=infer, dest="prior_stds", default=None)
...
parser.add_argument("--scaling", nargs='?', dest="scaling_bounds", type=infer, default=0.15)
parser.add_argument("--rotation", nargs='?', dest="rotation_bounds", type=infer, default=15)
parser.add_argument("--shearing", nargs='?', dest="shearing_bounds", type=infer, default=.012)
parser.add_argument("--translation", nargs='?', dest="translation_bounds", type=infer, default=False)
parser.add_argument("--nonlin_std", type=infer, dest="nonlin_std", default=3.)
parser.add_argument("--nonlin_shape_factor", type=infer, dest="nonlin_shape_factor", default=.04)
...
parser.add_argument("--bias_shape_factor", type=infer, dest="bias_shape_factor", default=.025)
