...
parser.add_argument("--segmentation_labels",
                    type=str,
...
parser.add_argument("--nonlin_shape_factor",
                    type=float,
...
parser.add_argument("--blur_range",
                    type=float,
                    dest="blur_range",
                    default=1.03)

# bias field parameters
parser.add_argument("--bias_std",
                    type=float,
                    dest="bias_field_std",
                    default=.5)
parser.add_argument("--bias_shape_factor",
                    type=float,
