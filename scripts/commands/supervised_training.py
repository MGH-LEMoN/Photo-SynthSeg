...
parser.add_argument("--nonlin_std", type=float, dest="nonlin_std", default=3.0)
parser.add_argument(
    "--nonlin_shape_factor", type=float, dest="nonlin_shape_factor", default=0.04
)
...
parser.add_argument("--bias_std", type=float, dest="bias_field_std", default=0.5)
parser.add_argument(
    "--bias_shape_factor", type=float, dest="bias_shape_factor", default=0.025
)
