...
class Configuration():
    ...
    def __init__(self):
        ...
        self.UW_HARD_RECON_HENRY = '/cluster/vive/UW_photo_recon/recons/results_Henry/Results_hard'
        self.UW_SOFT_RECON_HENRY = '/cluster/vive/UW_photo_recon/recons/results_Henry/Results_soft'
