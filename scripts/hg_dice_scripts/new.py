...
class Configuration:
    def __init__(self, project_dir, args):
        ...
        self.SYNTHSEG_RESULTS = os.path.join(
            ...
            "results",
            args.out_dir_name,
            f"{args.recon_flag}-recons-skip-{args.skip}",
            self.model_name,
        )

        # input folders
        self.UW_HARD_RECON = (
            "/space/calico/1/users/Harsha/SynthSeg/data/uw_photo/Photo_data/"
        )
        self.UW_SOFT_RECON = (
            "/space/calico/1/users/Harsha/SynthSeg/data/uw_photo/Photo_data/"
        )
        self.UW_MRI_SCAN = (
            "/space/calico/1/users/Harsha/SynthSeg/data/uw_photo/FLAIR_Scan_Data"
        )
